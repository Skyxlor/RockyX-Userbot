...
from RockyX import *
from RockyX import LOGGER
from pykillerx.helper import *

admins_in_chat = {}

def restart():
    os.execvp(sys.executable, [sys.executable, "-m", "RockyX"])
...
def git():
    ...
    try:
        repo = Repo()
        LOGGER("RockyX").info(f"Git Client Found")
    except GitCommandError:
        LOGGER("RockyX").info(f"Invalid Git Command")
        ...
        LOGGER("RockyX").info("Fetched Latest Updates")
