...
BRANCH = "dev"
REPO_URL = "https://github.com/Skyxlor/RockyX-Userbot"
...
app = Client(
    ...
    api_hash=API_HASH,
    bot_token=BOT_TOKEN,
    plugins=dict(root="RockyX/modules/bot"),
    in_memory=True,
)

if STRING_SESSION1:
   print("Client1: Found.. Starting..")
   client1 = Client(name="one", api_id=API_ID, api_hash=API_HASH, session_string=STRING_SESSION1, plugins=dict(root="RockyX/modules"))
